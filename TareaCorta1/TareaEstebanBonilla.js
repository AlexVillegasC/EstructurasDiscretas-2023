class Patient {
  ...
  patientQueue.enqueue(new Patient("Andre", 37));
  patientQueue.enqueue(new Patient("Vinicio", 14));
  patientQueue.enqueue(new Patient("Santiago", 75, true));
  
  console.log(patientQueue.count()); // Resultado: 3
  
  let nextPatient = patientQueue.dequeue();
  console.log(nextPatient); // Resultado: Patient { name: "Santiago", age: 75, emergency: true }
