class Stack {
    constructor() {
                       ...
                       const html4 = "<html><head><title>Prueba</title></head><body><h1>Esto es una prueba</h1></body>";
                       console.log(isHTMLBalanced(html4)); // false

                       const html5 = "<html><head><title>Prueba</title></head><body><h2>Esto es una prueba</p></body>";
