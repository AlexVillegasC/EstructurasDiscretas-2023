class Paciente {
  ...
  class ColaPacientes {
    ...
    mostrarCola() {
      ...
      for (let i = 0; i < this.cola.length; i++) {
        elementosEnCola += this.cola[i].nombre + " (" + this.cola[i].edad + " años), ";
      }
  ...
  colaPacientes.agregar(new Paciente("Pepe", 19));
  colaPacientes.agregar(new Paciente("Esteban", 20));
  colaPacientes.agregar(new Paciente("Michelle", 24));
  colaPacientes.agregar(new Paciente("Nicole", 70, true));
