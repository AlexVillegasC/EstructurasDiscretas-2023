class Patient {
  ...
  patientQueue.AñadirPaciente(new Patient("Roberto", 23));
  patientQueue.AñadirPaciente(new Patient("Eliza", 3, true));
  patientQueue.AñadirPaciente(new Patient("Messi", 28));
  patientQueue.AñadirPaciente(new Patient("Ashley", 40));
  patientQueue.AñadirPaciente(new Patient("Peter", 21, true));
