class Stack {
  ...
  const html4= "<html><h1></h1><img></img></html>"
  console.log(isHTMLBalanced(html4)); // true

  const html5= "<html><h1></h1><p></p><div></html>"
  console.log(isHTMLBalanced(html5)); // false

  const html6= "<html><h1></h1><h2></h2><p><br></br></p><a></a></html>"
  console.log(isHTMLBalanced(html6)); // true

  const html7= "<html><li><h1></h1></li><table></table><button></html>"
...
// R/ la complejidad espacial seria o(n^) y la complejidad temporal es o(n)
